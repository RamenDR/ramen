...
Installing this will give you a containerized stack that includes Prometheus,
AlertManager and Grafana.

For more detailed information and querying, consider using the Prometheus
Operator, but in summary:
...
section. Next is to install and configure ramen.
...
To get the list of all the Ramen metrics available and their descriptions, run
