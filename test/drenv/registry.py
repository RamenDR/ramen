...
# Ports start at 5050 to avoid conflict with macOS AirDrop (port 5000).
REGISTRIES = {
    "docker.io": {"port": 5050, "upstream": "https://registry-1.docker.io"},
    "quay.io": {"port": 5051, "upstream": "https://quay.io"},
    "ghcr.io": {"port": 5052, "upstream": "https://ghcr.io"},
    "gcr.io": {"port": 5053, "upstream": "https://gcr.io"},
    "registry.k8s.io": {"port": 5054, "upstream": "https://registry.k8s.io"},
}
