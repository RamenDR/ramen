...
func (in *DRPlacementControlSpec) DeepCopyInto(out *DRPlacementControlSpec) {
	*out = *in
	...
	if in.EligibleForProtectionNamespaces != nil {
		in, out := &in.EligibleForProtectionNamespaces, &out.EligibleForProtectionNamespaces
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
...
func (in *KubeObjectProtectionSpec) DeepCopyInto(out *KubeObjectProtectionSpec) {
	*out = *in
	...
	in.KubeObjectSelector.DeepCopyInto(&out.KubeObjectSelector)
}
