...
func (in *KubeObjectProtectionStatus) DeepCopyInto(out *KubeObjectProtectionStatus) {
	*out = *in
	...
	if in.CompletedCaptureWorkflowSteps != nil {
		in, out := &in.CompletedCaptureWorkflowSteps, &out.CompletedCaptureWorkflowSteps
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.CompletedRecoverWorkflowSteps != nil {
		in, out := &in.CompletedRecoverWorkflowSteps, &out.CompletedRecoverWorkflowSteps
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
