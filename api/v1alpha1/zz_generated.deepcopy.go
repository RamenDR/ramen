...
func (in *RecipeSpec) DeepCopyInto(out *RecipeSpec) {
	*out = *in
	...
	if in.CaptureWorkflowName != nil {
		in, out := &in.CaptureWorkflowName, &out.CaptureWorkflowName
		*out = new(string)
		**out = **in
	}
	if in.RecoverWorkflowName != nil {
		in, out := &in.RecoverWorkflowName, &out.RecoverWorkflowName
		*out = new(string)
		**out = **in
	}
...
func (in *StorageIdentifiers) DeepCopyInto(out *StorageIdentifiers) {
	*out = *in
	if in.StorageClassModes != nil {
		in, out := &in.StorageClassModes, &out.StorageClassModes
		*out = make([]MMode, len(*in))
		copy(*out, *in)
	}
	if in.VolumeReplicationClassModes != nil {
		in, out := &in.VolumeReplicationClassModes, &out.VolumeReplicationClassModes
		*out = make([]MMode, len(*in))
		copy(*out, *in)
	}
}
