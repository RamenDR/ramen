...
type DRClusterConfigStatus struct {
	...
	// NetworkFenceClas lists all the classes that match the provioner on the cluster that can be used for fencing
	// operations
	NetworkFenceClasses []string `json:"networkFenceClass,omitempty"`
}
