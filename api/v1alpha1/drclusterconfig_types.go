...
const (
	// DRClusterConfig has been validated
	DRClusterConfigValidated string = "Validated"
	// DRClusterConfig configuration has been processed
	DRClusterConfigConfigurationProcessed string = "Processed"
	// DRClusterConfig S3 is reachable
