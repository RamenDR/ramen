...
func (s Subscription) Deploy(ctx types.Context) error {
	...
	return waitSubscriptionPhase(ctx, hubNamespace, name, subscriptionv1.SubscriptionPropagated)
}
...
func (s Subscription) Undeploy(ctx types.Context) error {
	...
	return util.DeleteNamespace(util.Ctx.Hub.Client, hubNamespace, log)
}
