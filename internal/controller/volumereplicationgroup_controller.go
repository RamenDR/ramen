...
func (v *VRGInstance) IsDRActionInProgress() bool {
	...
	isPrimary := spec.ReplicationState == ramendrv1alpha1.Primary
	isStatePrimary := status.State == ramendrv1alpha1.PrimaryState

	if (isSecondary && !isStateSecondary) ||
		(isPrimary && !isStatePrimary) ||
