...
func drClusterPolicyObjectsToDeploy(hubOperatorRamenConfig *rmn.RamenConfig) []*cpcv1.ObjectTemplate {
	...
	objects := []*cpcv1.ObjectTemplate{
		...
		{
			ComplianceType:   cpcv1.MustHave,
			ObjectDefinition: runtime.RawExtension{Object: olmRoleBinding(drClusterOperatorNamespaceName)},
		},
		{
			ComplianceType:   cpcv1.MustHave,
			ObjectDefinition: runtime.RawExtension{Object: operatorGroup(drClusterOperatorNamespaceName)},
		},
		{
			ComplianceType:   cpcv1.MustHave,
		...
		{
			ComplianceType:   cpcv1.MustHave,
			ObjectDefinition: runtime.RawExtension{Object: drClusterConfigRole},
		},
		{
			ComplianceType:   cpcv1.MustHave,
			ObjectDefinition: runtime.RawExtension{Object: drClusterConfigRoleBinding},
		},
	}
