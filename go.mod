...
require (
	...
	github.com/csi-addons/kubernetes-csi-addons v0.10.1-0.20250714123342-5100f91e506c
...
replace k8s.io/client-go v12.0.0+incompatible => k8s.io/client-go v0.33.2
