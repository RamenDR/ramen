...
require (
	...
	github.com/csi-addons/kubernetes-csi-addons v0.8.1-0.20240709090842-7d3f7a5e96f0
...
require (
	...
	github.com/csi-addons/spec v0.2.1-0.20240619103729-12c61f25a2a5 // indirect
